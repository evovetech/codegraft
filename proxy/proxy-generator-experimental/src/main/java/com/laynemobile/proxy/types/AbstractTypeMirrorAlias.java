...
abstract
class AbstractTypeMirrorAlias<T extends TypeMirror>
        extends AbstractAnnotatedConstructAlias<T>
        implements TypedTypeMirrorAlias<T>
{
    ...
    static
    TypeMirrorAlias unknown(TypeMirror typeMirror) {

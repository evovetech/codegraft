...
final
class DefaultTypeElementAlias
        extends AbstractElementAlias<TypeElement>
        implements TypeElementAlias
{
    ...
    private
    DefaultTypeElementAlias(TypeElement element) {
        super(element);
        try {
    ...
    static
    TypeElementAlias of(TypeElement element) {
    ...
    @Override public
    ImmutableList<? extends TypeMirrorAlias> getInterfaces() {
        return interfaces;
    }

    @Override public
    ImmutableList<? extends TypeParameterElementAlias> getTypeParameters() {

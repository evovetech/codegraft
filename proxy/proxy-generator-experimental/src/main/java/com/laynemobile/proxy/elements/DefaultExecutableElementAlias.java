...
final
class DefaultExecutableElementAlias
        extends AbstractElementAlias<ExecutableElement>
        implements ExecutableElementAlias
{
    ...
    private
    DefaultExecutableElementAlias(ExecutableElement element) {
        super(element);
    ...
    static
    ExecutableElementAlias of(ExecutableElement element) {
    ...
    @Override public
    ImmutableList<? extends VariableElementAlias> getParameters() {
        return parameters;
    }
    ...
    @Override public
    ImmutableList<? extends TypeMirrorAlias> getThrownTypes() {
        return thrownTypes;
    }

    @Override public
    ImmutableList<? extends TypeParameterElement> getTypeParameters() {
    ...
    boolean equals(Object o) {
        ...
        return Objects.equal(defaultValue, that.defaultValue) &&
                ...
                Objects.equal(receiverType, that.receiverType) &&
                Objects.equal(isDefault, that.isDefault) &&

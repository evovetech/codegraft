...
import com.laynemobile.proxy.AbstractAnnotatedConstructAlias;
...
abstract
class AbstractElementAlias<E extends Element>
        extends AbstractAnnotatedConstructAlias<E>
        implements TypedElementAlias<E>
{
    ...
    static
    ElementAlias unknown(Element element) {
        final
        class UnknownElementAlias
                extends AbstractElementAlias<Element>
        {
            private
            UnknownElementAlias(Element element) {
                super(element);
            }
    ...
    @Override public
    ImmutableList<? extends ElementAlias> getEnclosedElements() {

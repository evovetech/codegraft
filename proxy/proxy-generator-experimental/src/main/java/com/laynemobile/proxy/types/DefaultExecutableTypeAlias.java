...
final
class DefaultExecutableTypeAlias
        extends AbstractTypeMirrorAlias<ExecutableType>
        implements ExecutableTypeAlias
{
    ...
    private
    DefaultExecutableTypeAlias(ExecutableType typeMirror) {
        super(typeMirror);
    ...
    static
    ExecutableTypeAlias of(ExecutableType executableType) {
    ...
    @Override public
    ImmutableList<? extends TypeMirrorAlias> getParameterTypes() {
    ...
    @Override public
    ImmutableList<? extends TypeVariableAlias> getTypeVariables() {

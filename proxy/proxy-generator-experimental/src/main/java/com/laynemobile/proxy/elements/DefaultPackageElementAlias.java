...
final
class DefaultPackageElementAlias
        implements PackageElementAlias
{
    ...
    private
    DefaultPackageElementAlias(PackageElement element) {
    ...
    static
    PackageElementAlias of(PackageElement element) {

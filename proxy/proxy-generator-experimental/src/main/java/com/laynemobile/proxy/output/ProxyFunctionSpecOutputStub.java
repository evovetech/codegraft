...
public class ProxyFunctionSpecOutputStub extends AbstractTypeElementOutputStub<ProxyFunctionSpecOutput> {
    ...
    private ProxyFunctionSpecOutputStub(AnnotatedProxyElement parent, ProxyFunctionElement function,
    ...
    private ProxyFunctionSpecOutputStub(ProxyFunctionSpecOutputStub source, TypeMirror superClass) {
    ...
    public static ProxyFunctionSpecOutputStub create(ProxyFunctionElement function) {
        ...
        return new ProxyFunctionSpecOutputStub(parent, function, baseClassName);
    }
    ...
    public ProxyFunctionSpecOutputStub withSuperClass(TypeMirror superClass) {
        return new ProxyFunctionSpecOutputStub(this, superClass);
    }
...
//                        .build())
    ...
    @Override protected ProxyFunctionSpecOutput convert(TypeElementOutput output) {
        return new ProxyFunctionSpecOutput(this, output.typeSpec(), output.didWrite());
    }
}

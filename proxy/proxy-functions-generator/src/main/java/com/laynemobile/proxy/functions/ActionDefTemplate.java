...
public class ActionDefTemplate extends AbstractFunctionDefTemplate {
    private static final String CLASS_NAME_TEMPLATE = "Action${LENGTH}Def";

    public ActionDefTemplate(String packageName, int length) {
    ...
    private static final String TEMPLATE = "" +
            ...
            "\n" +
            "public class ${CLASS_NAME}<${TYPE_ARGS}> extends ActionDef<Action${LENGTH}Transform<${TYPE_ARGS}>> {\n" +

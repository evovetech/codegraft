...
public class AbstractFunctionDefTemplate extends AbstractFunctionTemplate {
    protected final String[] type_token_parameters;

    public AbstractFunctionDefTemplate(String packageName, String className, String template, int length) {
        super(packageName, className, template, length);

...
import sourcerer.google.auto.factory.processor.AutoFactoryDeclaration.Factory;
...
final class FactoryDescriptorGenerator {
  ...
  private final Factory declarationFactory;
          ...
          if (constructors.isEmpty()) {
            ...
            return FluentIterable.from(constructors)
                .transform(new Function<ExecutableElement, FactoryMethodDescriptor>() {
                  @Override public
                  FactoryMethodDescriptor apply(ExecutableElement constructor) {
